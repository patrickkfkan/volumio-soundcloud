...
var _BaseModel_instances, _BaseModel_api, _BaseModel_doLoopFetch;
...
class BaseModel {
    constructor() {
        ...
        _BaseModel_api.set(this, void 0);
    }
    getSoundCloudAPI() {
        if (!__classPrivateFieldGet(this, _BaseModel_api, "f")) {
            __classPrivateFieldSet(this, _BaseModel_api, new soundcloud_fetch_1.default(), "f");
        }
        return __classPrivateFieldGet(this, _BaseModel_api, "f");
    }
    loopFetch(params) {
    ...
    commonGetNextPageTokenFromLoopFetchResult(result, params) {
        const items = result.items;
        if (items.length > 0 && result.nextUri) {
            const offset = Number(params.pageToken) || 0;
            return (offset + soundcloud_fetch_1.Constants.QUERY_MAX_LIMIT).toString();
        }
        return null;
    }
}
exports.default = BaseModel;
_BaseModel_api = new WeakMap(), _BaseModel_instances = new WeakSet(), _BaseModel_doLoopFetch = async function _BaseModel_doLoopFetch(params, currentList = [], iteration = 1) {
