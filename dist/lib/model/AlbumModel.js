...
class AlbumModel extends BaseModel_1.default {
    ...
    async getAlbum(albumId, options = {}) {
        ...
        if (options.loadTracks && album && info) {
            ...
            album.tracks = tracks?.reduce((result, t) => {
...
_AlbumModel_instances = new WeakSet(), _AlbumModel_getAlbumsFetchPromise = function _AlbumModel_getAlbumsFetchPromise(params) {
